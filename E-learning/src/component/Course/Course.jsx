...
function Course() {
  ...
  return (
    <section className="course" id="course">
      ...
      <div className="secondary"><h5>Discover our most sought-after courses, carfuly curated to meet the <br />
        <span id="span2">demands of today's learners. Dive into engaging content crafted</span> <br />
        <span id="span1">for success in evry step of your educational journey.</span> </h5>
      </div>
      ...
      <div className="course-content">
        ...
        <div className="rowing">
          ...
          <div className="course">
            ...
            <h3>The Complete HTML CSS JS Course 2024</h3>
        ...
        <div className="course-contnent">
          <div className="rowing">
           <Link to="/Data"><img src="photo_5764824702806769758_x.jpg" alt="" id="im" /></Link> 
            <div className="course">
              <h5 className="web">Web Design</h5>
              <h3>The Complete Data Analyst Bootcamp </h3>
              <p>Lorem ipsum dolor sit amet consectetur.<br />Lorem, ipsum dolor.</p>
              <h6>05 hours 15 minutes</h6>
            </div>
            <div className="rating">
      ...
      <div className="bhom">
       <Link to="/Coding"><button className="button bhome">Explore More</button></Link> 
      </div>
    </section >
  )
}
