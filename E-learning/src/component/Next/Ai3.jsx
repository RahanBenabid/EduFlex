...
import data from "../../util/Ai3.json";
import "swiper/css";
            ...
            <div className="dev">
                ...
                <div className="video">
                    ...
                    <div className="description">
                        ...
                        <h6>
                            Welcome to the Comprehensive AI Fundamentals Course! Throughout this course, <br />
                            ...
                            while delving into the latest topics relevant to the field,
                        </h6>
