...
import cdata from "../../util/compslider.json";
import "swiper/css";
import { sliderSettings } from "../../util/commob";
import Marker from "../../component/Marker/Marker"
function Compnext() {

    const externalSourse = 'https://www.youtube.com/watch?v=zOjov-2OZ0E';
    const internalSourse = '';
    return (<>
        ...
        <section className="r-container">
            ...
            <div className="dev">
                <h2>A Great bigening to enter the world of programming</h2>
                ...
                <div className="course-text">
                    ...
                    <div className="jas ">
                        ...
                        <ul className="contenu mm">
                            <li>Introduction to Programming<br />
                                <span id="sp"> In this chapter, you'll learn about the fundamentals of programming, including what programming is, its applications, and the different types of programming languages. You'll also explore the basics of problem-solving and algorithmic thinking.</span>
                            </li>
                            <li>Data Types and Variables<br />
                                <span id="sp">Discover the various data types used in programming, such as integers, floating-point numbers, booleans, and strings. Learn how to declare and manipulate variables, which are used to store and manipulate data in programs.
                                </span></li>
                            <li>Control Structures and Loops <br />
                                <span id="sp">Dive into control structures like conditional statements (if-else, switch) and loops (for, while, do-while), which are essential for controlling the flow of program execution based on certain conditions or repetitive tasks.</span></li>
                            <li>Object-Oriented Programming<br />
                                <span id="sp">Understand the principles of object-oriented programming (OOP), including classes, objects, inheritance, encapsulation, and polymorphism. Learn how to design and implement object-oriented programs using these concepts.</span></li>
                            <li> Programming Paradigms and Best Practices<br />
                                <span id="sp">In this chapter, you'll explore different programming paradigms, such as procedural, functional, and event-driven programming.</span>
                            </li>
                        </ul>
