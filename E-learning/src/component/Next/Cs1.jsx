...
import data from "../../util/cs1.json";
import "swiper/css";
...
function Cs1() {
    ...
    return (<>
        ...
        <section className="r-container">
            ...
            <div className="dev">
                <h2>Cyber Security: From Beginner to Expert (2024)</h2>
                ...
                <div className="video">
                    ...
                    <div className="description">
                        ...
                        <h6>Cyber Security made easy for absolute beginners - learn
                            from an industry expert with PhD  </h6>
