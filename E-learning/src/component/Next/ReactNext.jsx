...
import data from "../../util/reactslider.json";
import Marker from "../../component/Marker/Marker"
import "swiper/css";
import { sliderSettings } from "../../util/commob";
function ReactNext() {

    const externalSourse = 'https://www.youtube.com/watch?v=CgkZ7MvWUAA&t=5482s';
                ...
                <div className="course-text">
                    ...
                    <div className="jas">
                        ...
                        <ul className="contenu sss">
                            <li>Introduction to React<br />
                                <span id="sp">In this chapter, you'll learn about the basics of HTML (Hypertext Markup Language).
                                </span>
                            </li>
                            <li>React and Frameworks<br />
                                <span id="sp">Explore different ways to format text , such as bold, italic, underline, and strikethrough. You'll also learn how to create headings of different levels.
                                    <br />
                                </span></li>
                            <li>Links, Images, and Multimedia<br />
                            ...
                            <li>Working with Forms and URLs <br />
                                <span id="sp">This chapter covers handling form data submitted from HTML forms and retrieving data from URLs using PHP's built-in superglobal variables .</span></li>
